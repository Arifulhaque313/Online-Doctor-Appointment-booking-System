    ...
    <div class="container">
        <div class="row mt-1 mb-5">
            ...
            <div class="col-6 pt-5">
                ...
                <h1 class="text-center">Doctor Registation</h1>
                <form action="../database/submit_doctors_sign_up.php" method="post">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="" class="form-label">Appoint for</label>
                    ...
                    <div class="mb-3">
                        <label for="" class="form-label">Degrees</label>
                        <input type="text" class="form-control" name="degrees" >
                    </div>

                    <div class="mb-3">
                        <label for="" class="form-label">Visit</label>
