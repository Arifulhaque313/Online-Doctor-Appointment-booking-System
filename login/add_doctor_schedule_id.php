    ...
    <div class="container">
        <div class="row mt-1 mb-5">
            ...
            <div class="col-6 pt-5">
                ...
                <h1 class="text-center">Add Doctor Schedule ID</h1>
                <form action="doctor_schedule_information.php" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        <label for="" class="form-label">Doctor's id</label>
