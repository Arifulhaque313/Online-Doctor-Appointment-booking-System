            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../hospital1.php">Hospitals</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="container">
        <div class="row mt-1 mb-5">
            ...
            <div class="col-6 pt-5">
                ...
                <h1 class="text-center">Blood Donate Form</h1>
                <form action="../database/blood_sign_up.php" method="post">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="bgroup" Required>
                    </div>

                    <div class="mb-3">
                        <label for="" class="form-label">Last Blood Donate</label>
                        <input type="date" class="form-control" min="2019-01-01" max="2022-01-01" name="ddate" >
                    </div>
