<?php
  ...
  if(isset($_POST['submit'])){
    ...
    $hotline = mysqli_real_escape_string($link,$_POST['hotline']);
    ...
    elseif(strlen ($address) < 12){
      ...
      $query="insert into hospital(hname, email, hotline, mobile, address, himage) values('$hname','$email','$hotline', '$mobile','$address','$folder')";
...
<script>
    ...
    window.location.href="dashboards/sad_hospitals.php";
</script>
