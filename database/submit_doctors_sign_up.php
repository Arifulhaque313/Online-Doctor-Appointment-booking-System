<?php
  ...
  if(isset($_POST['submit'])){
    ...
    $degrees = mysqli_real_escape_string($link,$_POST['degrees']);
    $visit = mysqli_real_escape_string($link,$_POST['visit']);
    ...
    if($email_count>0){
      ...
      <script>
        ...
        window.location.href="../login/doctors_sign_up.php";
      </script>
      <?php  
    ...
    elseif(strlen ($address) < 12){
      ...
      $query="insert into testusers(name, email, password, cpassword, mobile, address, role, hospital, speciality, degrees, visit) values('$name','$email','$pass','$cpass','$mobile','$address','$role', '$hospital','$speciality','$degrees','$visit')";
...
<script>
    ...
    window.location.href="../dashboards/ad_doctors.php";
</script>
