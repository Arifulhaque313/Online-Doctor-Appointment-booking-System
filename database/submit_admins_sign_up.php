  ...
  if(isset($_POST['submit'])){
    ...
    if($email_count>0){
      ...
      <script>
        ...
        window.location.href="../login/admins_sign_up.php";
      </script>
      <?php  
    ...
    elseif(strlen ($address) < 12){
      ...
      $query="insert into testusers(name, email, password, cpassword, mobile, address, role, hospital) values('$name','$email','$pass','$cpass','$mobile','$address','$role', '$hospital')";
...
<script>
    ...
    window.location.href="../dashboards/sad_admins.php";
</script>
