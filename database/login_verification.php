...
if(isset($_POST['submit'])){
    ...
    if($email_count){
        ...
        $_SESSION['hospital'] = $email_pass['hospital'];
        ...
        if($pass_decode){
            ...
            elseif($role === "admin" && $db_role === "admin"){
                ?>
                <script>
            ...
            elseif($role ==="doctor" && $db_role === "doctor"){
                ?>
                <script>
            ...
            elseif($role === "superadmin" && $db_role === "superadmin"){
                ?>
                <script>
