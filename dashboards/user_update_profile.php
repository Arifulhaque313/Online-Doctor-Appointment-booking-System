    ...
    <div class="container">
        <div class="row mt-1 mb-5">
            ...
            <div class="col-6 pt-5">
                ...
                <form action="../database/update_user_profile.php" method="post">
                    <div class="mb-3">
                        <label for="" class="form-label">Name</label>
                        <input type="text" class="form-control" name="name1" value="<?php  echo $_SESSION['name']; ?>" Required>
                    </div>

                    <div class="mb-3">
                        <label for="" class="form-label">Email</label>
                        <input type="email" class="form-control" name="email" value="<?php  echo $_SESSION['email']; ?>" disabled Required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="mobile1" value="<?php  echo $_SESSION['mobile']; ?>" Required>
                    </div>
                    <div class="mb-3">
                        <label for="" class="form-label">Address</label>
                        <input type="text" class="form-control" name="address1" value="<?php  echo $_SESSION['address']; ?>" Required>
                    </div>
