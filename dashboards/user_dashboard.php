...
<body>
    ...
    <div class="sidebar">
        <div class="sidebar-brand">
            <h1><span class="lab la-accusoft"></span><span>User Dashboard</span></h1>
        </div>
            ...
            <ul>
                <li>
                    <a href="" class="active"><span class="las la-igloo"></span>
                        <span class="spanli">Dashboard</span></a>
                </li>
                <li>
                    <a href="../hospital.php" class="" target="_blank"><span class="las la-hospital"></span>
                        <span class="spanli">Hospital</span></a>
                </li>
    ...
    <div class="main-content">
        <header>
            ...
            <div class="user-wrapper">
                ...
                <div>
                    <div class="dropdown1">
                        <h5 class="dropbtn1"><?php   echo $_SESSION['name'] ?></h5>
            ...
            <div class="row">
                <div class="col-lg-4 col-12">
                    ...
                    <div class="card" style="width: 21rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title py-2 fw-bold">Appointments</h5>
                            <div class="row">
                                ...
                                <div class="col-3 pt-3" style="font-size:30px; color:#2CABE3">
                                    <p><b><?php echo user_appointment_count();  ?></b></p>
                                </div>
                            </div>


                            <center>
                                <a href="view_appointment_list.php"><button class="btn btn-primary">View my
