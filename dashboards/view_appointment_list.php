            ...
            while($row = mysqli_fetch_assoc($result)){
          	...
          	?>
                ...
                <tr>
                    ...
                    <td class=""><a href="view_appointment.php?id=<?php echo $docid ?>& appdate=<?php echo $appdate ?>" style="text-decoration:none;" class="badge bg-success">view appointment</a></td>
                    
                    <td class=""><a href="../database/drop_appointment.php?id=<?php  echo $appid  ?>" style="text-decoration:none;" class="badge bg-danger">cancel</a></td>
                </tr>
