    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="d_appointment.php" ><span class="las la-clipboard-list"></span>
                        <span>Appointments</span></a>
                </li>

                <li>
                    <a href="d_schedule.php" class="active"><span class="las la-clock"></span>
    ...
    <div class="main-content">
        ...
        <main>
            ...
            <div class="card" style="width: 21rem;">
                ...
                <div class="card-body">
                    <h5 class="card-title py-2 fw-bold">Schedule</h5>
                    <div class="row">
                        <div class="col-4 " style="font-size:50px; color:#7ACE4C;"><span
                                class="las la-book-medical"></span>
                        </div>
                        <div class="col-2"></div>
                        <div class="col-6 pt-3" style="font-size:30px;  color:#7ACE4C">
                        <a href="doctor_schedule.php" ><button class="btn btn-primary">view Schedule</button></a>
                        </div>
                    </div>

                </div>

                <center class="my_3"></center>
            </div>
