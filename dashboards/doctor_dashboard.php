...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                <li>
                    <a href="doctor_dashboard.php" class="active"><span class="las la-igloo"></span>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12">
                    ...
                    <div class="card" style="width: 21rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title py-2 fw-bold">Update Status</h5>
                            <div class="row">
                                <div class="col-4 " style="font-size:50px; color:#2CABE3;"><span
                                        class="las la-book-medical"></span>
                                </div>
                                ...
                                <center>
                                <a href="doctor_update_status.php"><button
