    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="ad_appointment.php" class="active"><span class="las la-clipboard-list"></span>
                ...
                <div class="col-lg-4 col-12 my-2">
                    <div class="card" style="width: 21rem;">
                        ...
                        <div class="card-body">
                            ...
                            <center>
                                <a href="view_admin_appointment_list.php?>"><button class="btn btn-primary">View
                                        
                                    </button></a>


                                    
                                <a href="ad_delete_appointment.php" ><button class="btn btn-danger">Delete
