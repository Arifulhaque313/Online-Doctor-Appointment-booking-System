...
<body>
    ...
    <div class="sidebar">
        <div class="sidebar-brand">
            <h1><span class="lab la-accusoft"></span><span>Doctor Dashboard</span></h1>
        </div>
        ...
        <div class="sidebar-menu">
            <ul>
                <li>
                    <a href="doctor_dashboard.php"><span class="las la-igloo"></span>
                        <span>Dashboard</span></a>
                </li>

                <li>
                    <a href="d_appointment.php" class="active"><span class="las la-clipboard-list"></span>
                        <span>Appointments</span></a>
                </li>

                <li>
                    <a href="d_schedule.php"><span class="las la-clock"></span>
            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-3 pt-3" style="font-size:30px; color:#2CABE3">
                                    <p><b><?php echo doctor_appointment_count();  ?></b></p>
                                </div>
                            </div>


                            <center>
                                <a href="view_doctor_appointment_list.php?id=<?php echo $_SESSION['id'] ?>"><button
                                        class="btn btn-primary">View Appointment
                                    </button></a>
                ...
                <div class="col-lg-6 col-12">
                    <div class="card" style="width: 21rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title py-2 fw-bold">Todays Appointments</h5>
                            <div class="row">
                                <div class="col-4 " style="font-size:50px; color:green;"><span
                                        class="las la-book-medical"></span>
                                </div>
                                <div class="col-5"></div>
                                <div class="col-3 pt-3" style="font-size:30px; color:green">
                                    <p><b><?php echo todays_doctor_appointment_count();  ?></b></p>
                                </div>
                            </div>


                            <center>
                                <a href="view_today_doctor_appointment_list.php?id=<?php echo $_SESSION['id'] ?>"><button
                                        class="btn btn-success">View Appointment
                                    </button></a>
