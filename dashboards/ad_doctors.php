    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="ad_doctors.php" class="active"><span class="las la-stethoscope"></span>
                        <span>Doctors</span></a>
                </li>
                <li>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-12 my-2">
                    <div class="card" style="width: 21rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title py-2 fw-bold">View Doctors</h5>
                            <div class="row">
                                ...
                                <div class="col-5 pt-3" style="font-size:30px; color:">
                                    <a href="view_doctor_list.php" class=""
                                        style="text-decoration : none; padding: 8px 10px; background-color:#707CD2; color: white; font-size:16px; border-radius:5px">Doctor
                                        List</a>
                                </div>
                            </div>
                ...
                <div class="col-lg-4 col-12 my-2">
                    <div class="card" style="width: 21rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title py-2 fw-bold">Add Doctor</h5>
                            <div class="row">
                                ...
                                <div class="col-3 pt-3" style="font-size:30px;  color:#7ACE4C">
                                    <a href="../login/doctors_sign_up.php" class=""
                ...
                <div class="col-lg-4 col-12 my-2">
                    <div class="card" style="width: 21rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title py-2 fw-bold">Remove Doctor</h5>
                            <div class="row">
                                ...
                                <div class="col-3 pt-3" style="font-size:30px; color:#2CABE3">
                                    <a href="../login/delete_doctor_form.php" class=" "
