    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="sad_admins.php" class="active"><span class="las la-user-cog"></span>
                        <span>Admins</span></a>
                </li>
            ...
            <div class="row">
                <div class="col-lg-4 col-12">
                    <div class="card m-3" style="width: 21rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title py-2 fw-bold">View Admins</h5>
                            <div class="row">
                                <div class="col-4 " style="font-size:50px; color:#707CD2;"><span
                                        class="las la-user-cog"></span>
                                </div>

                                <div class="col-8 pt-3" style="font-size:30px; color:">
                                    <a href="view_admin_list.php" class=""
                ...
                <div class="col-lg-4 col-12">
                    ...
                    <div class="card m-3" style="width: 21rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title py-2 fw-bold">Add Admin</h5>
                            <div class="row">
                                ...
                                <div class="col-5 pt-3" style="font-size:30px;  color:#7ACE4C">
                                    <a href="../login/admins_sign_up.php" class=""
                ...
                <div class="col-lg-4 col-12">
                    ...
                    <div class="card m-3" style="width: 21rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title py-2 fw-bold">Drop Admin</h5>
                            <div class="row">
                                ...
                                <div class="col-5 pt-3" style="font-size:30px; color:#2CABE3">
                                    <a href="../login/delete_admin_form.php" class=" "
