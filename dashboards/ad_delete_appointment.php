...
$query = "select * from appointments where apphospital = '$hospital'";
...
<div class="row my-5">
            ...
            <form action="../database/admin_delete_appointment.php" method="post">


            <div class="mx-3">
                    <label for="" class="form-label ">Hospital Name</label>
                    <input type="text" class="form-control my-3" name="hospital" value="<?php echo $hospital ?>">
                    ...
                    <input type="text" class="form-control my-3" name="deldate" placeholder="Please Enter date dd-mm-year">
