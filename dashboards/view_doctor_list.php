          	...
          	?>
                <div class="col-lg-4   col-12 my-3">
                    <div class="card">
                        ...
                        <img src="<?php echo $image; ?>" height="400" class="card-img-top" alt="Hospital Image">
                        <div class="card-body my-3">
                            <h5 class="card-title"> <b>Name: </b><?php echo $name; ?></h5>
                            
                            <p class="card-text"><span class="lab la-orcid"></span> <span><b>ID :
                            ...
                            <div class="text-end mt-5"> <a href="../database/delete_doctor_2.php?id=<?php   echo $id ?>" style="text-decoration:none;" class="badge bg-danger">Drop Doctor</a></div>
