...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="ad_admins.php" class="active"><span class="las la-user-cog"></span>
                        <span>Admins</span></a>
                </li>

                <li>
                    <a href="ad_hospitals.php"><span class="las la-hospital"></span>
    ...
    <div class="main-content ">
        ...
        <main>
         ...
         <!--SUper admin dashboard admin page-->
         <div class="main2 row">
            <div class="col-4 ">
            ...
            <div class="col-4">
                <div class="card bg-warning" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text"></p>
                        <center><a href="" class="btn btn-success">Add</a></center>
                    </div>
                </div>
            </div>
            ...
            <div class="col-4">
                ...
                <div class="card bg-danger" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        <center>
                            <h1 class="card-title">Drop Admin</h1>
                        </center>
                        <p class="card-text"></p>
                        <center><a href="#" class="btn btn-success">Drop</a></center>
                    </div>
                </div>
            </div>
