...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                <li>
                    <a href="admin_dashboard.php"><span class="las la-igloo"></span>
                ...
                <li>
                    <a href="ad_schedule.php" class="active"><span class="las la-clock"></span>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-12 my-2">
                    <div class="card" style="width: 21rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title py-2 fw-bold">View Doctor's Schedule</h5>
                            <div class="row">
                                <div class="col-4 " style="font-size:50px; color:#707CD2;"><span
                                        class="las la-user-nurse"></span>
                                </div>
                                <div class="col-3"></div>
                                <div class="col-5 pt-3" style="font-size:30px; color:">
                                    <a href="view_doctor_schedule.php" class=""
                                        style="text-decoration : none; padding: 8px 10px; background-color:#707CD2; color: white; font-size:16px; border-radius:5px">
                                        View</a>
                                </div>
                            </div>
                ...
                <div class="col-lg-4 col-12 my-2">
                    <div class="card" style="width: 21rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title py-2 fw-bold">Add Doctor Schedule</h5>
                            <div class="row">
                                ...
                                <div class="col-3 pt-3" style="font-size:30px;  color:#7ACE4C">
                                    <a href="../login/add_doctor_schedule_id.php" class=""
                ...
                <div class="col-lg-4 col-12 my-2">
                    ...
                    <div class="card" style="width: 21rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title py-2 fw-bold">Update Schedule</h5>
                            <div class="row">
                                ...
                                <div class="col-5 pt-3" style="font-size:30px; color:#2CABE3">
                                    <a href="../login/add_doctor_schedule_id.php" class=" "
                                        style="text-decoration : none; padding: 8px 10px; background-color:#2CABE3; color: white; font-size:16px; border-radius:5px">Update</a>
                                </div>
                            </div>
