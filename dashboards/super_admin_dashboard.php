...
<body>
    ...
    <!--super admin dashboard section start -->



    <!--super admin dashboard left side start -->

    <input type="checkbox" id="nav-toggle"> 
    <div class="sidebar">
        <div class="sidebar-brand">
            <h1><span class="lab la-accusoft"></span><span>Super Admin Dashboard</span></h1>
        </div>
    ...
    <div class="main-content ">
        ...
        <!--Dashboard Main content right end-->
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-12">
                    ...
                    <div class="card my-3" style="width: 21rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title py-2 fw-bold">Total Hospitals</h5>
                            <div class="row">
                                ...
                                <div class="col-3 pt-3" style="font-size:30px; color:#2CABE3">
                                    <p><b><?php echo hospital_count(); ?></b></p>
                                </div>
                            </div>
                ...
                <div class="col-lg-4 col-12">
                    <div class="card my-3" style="width: 21rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title py-2 fw-bold">Total Doctor</h5>
                            <div class="row">
                                ...
                                <div class="col-3 pt-3" style="font-size:30px;  color:#7ACE4C">
                                    <p><b><?php echo total_doctor_count(); ?></b></p>
                                </div>
                            </div>
                ...
                <div class="col-lg-4 col-12">
                    <div class="card my-3" style="width: 21rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title py-2 fw-bold">Total Admin</h5>
                            <div class="row">
                                <div class="col-4 " style="font-size:50px; color:#707CD2;"><span
                                        class="las la-users-cog"></span>
                                </div>
                                <div class="col-5"></div>
                                <div class="col-3 pt-3" style="font-size:30px; color:#707CD2">
                                    <p><b><?php echo total_admin_count() ?></b></p>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-12">
                    ...
                    <div class="card" style="width: 21rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title py-2 fw-bold">Total User</h5>
                            <div class="row">
                                <div class="col-4 " style="font-size:50px; color:crimson;"><span
                                        class="las la-users"></span>
                                </div>
                                <div class="col-5"></div>
                                <div class="col-3 pt-3" style="font-size:30px; color:crimson">
                                    <p><b><?php echo user_count(); ?></b></p>
                                </div>
                            </div>
